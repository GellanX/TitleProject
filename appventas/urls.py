...
urlpatterns = [
    ...
    path('insumos/listar/', views.listar_insumos, name='listar_insumos'),
    path('inventario/agregar_editar_insumo/', views.agregar_insumo, name='agregar_insumo'),
    path('inventario/agregar_editar_insumo/<int:insumo_id>/', views.editar_insumo, name='editar_insumo'),
